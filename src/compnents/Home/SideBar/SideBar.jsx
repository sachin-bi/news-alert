  ...
  return (
    <>
      <div className="sticky top-0 min-h-dvh  ">
        <ul className=" mx-8 flex flex-col  justify- py-5 
        text-base font-normal gap-1 sticky top-0">
          <li className="hover:font-medium py-2">    <NavLink to="/" 
                            className={({isActive})=>`rounded ${isActive ? "font-bold " : "font-normal"} px-2`} 
